    ...
    TimeProvider timeProvider) : PageModel
{
    ...
    public sealed record InputModel
    {
        ...
        public static InputModel FromFixture(DemoReleaseFixture fixture) => new()
        {
            ...
            DeploymentWindowStart = LocalDateTimeDisplay.ToLocal(fixture.DeploymentWindowStart),
            DeploymentWindowEnd = LocalDateTimeDisplay.ToLocal(fixture.DeploymentWindowEnd),
            IncludeTestEvidence = fixture.IncludeTestEvidence,
            TestRunVersion = fixture.TestRunVersion,
            TestCompletedAt = LocalDateTimeDisplay.ToLocal(fixture.TestCompletedAt),
            ...
            SecurityScannedAt = LocalDateTimeDisplay.ToLocal(fixture.SecurityScannedAt),
            ...
            ChangeWindowStart = LocalDateTimeDisplay.ToLocal(fixture.ChangeWindowStart),
            ChangeWindowEnd = LocalDateTimeDisplay.ToLocal(fixture.ChangeWindowEnd),
        };
